...
const Profile = () => {
  return (
    <div className="flex items-center justify-end space-x-5  cursor-pointer">
      {/* notification */}
      ...
      {/* profile avatar*/}
        <div className="w-10">
            <img src="https://placeimg.com/192/192/people" alt="profile avatar" className="rounded-full" />
        </div>
    </div>
  );
};
